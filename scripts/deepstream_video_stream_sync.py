...
class SimpleDeepStreamPipeline:
    ...
    def on_bus_message(self, bus, message):
        ...
        if t == Gst.MessageType.EOS:
            ...
            self.pipeline.seek_simple(
                Gst.Format.TIME,  # Format in time
                Gst.SeekFlags.FLUSH | Gst.SeekFlags.KEY_UNIT,  # Flags
                0  # Position: start of the file
            )
    ...
    def on_new_sample(self, sink):
        ...
        if result:
            ...
            frame_bgr = put_text_with_fringe(
                frame_bgr, 
            ...
            if self.total_frames % 30 == 0:  # Print every 30 frames to avoid console spam
